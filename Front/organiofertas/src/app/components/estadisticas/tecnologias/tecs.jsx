...
export default function Tecs({ id }) {
  ...
  const tecsMas = matrix ? tecnologiasMasComunes(matrix) : null;
  ...
  if (matrix) {
    ...
    return null; // Otra opción es mostrar un mensaje de carga o algo similar mientras se obtienen los datos
  }
}